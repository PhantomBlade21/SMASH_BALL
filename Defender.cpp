...
Defender::Defender()
{
	...
	m_Health_Stat = ((rand() % 10) + 1) + ((rand() % 10) + 1) + ((rand() % 10) + 1) + ((rand() % 10) + 1) + ((rand() % 10) + 1) + ((rand() % 10) + 1);
	m_Shoot_Stat = ((rand() % 10) + 1);
	m_Pass_Stat = ((rand() % 10) + 1) + ((rand() % 10) + 1);
	m_Block_Stat = (((rand() % 10) + 1) + ((rand() % 10) + 1)) + ((rand() % 5) + 1);
	m_Steal_Stat = (((rand() % 10) + 1) + ((rand() % 10) + 1)) + ((rand() % 5) + 1);
